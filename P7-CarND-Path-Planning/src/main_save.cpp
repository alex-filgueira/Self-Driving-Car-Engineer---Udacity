      ...
      if (s != "") {
        ...
        if (event == "telemetry") {
         ...
         double ref_yaw = deg2rad(car_yaw);
          ...
          vector<double> next_pts1 = getXY(car_nextS+38, 2+4*next_car_road_lane,map_waypoints_s,map_waypoints_x,map_waypoints_y);
          vector<double> next_pts2 = getXY(car_nextS+68, 2+4*next_car_road_lane,map_waypoints_s,map_waypoints_x,map_waypoints_y);
          vector<double> next_pts3 = getXY(car_nextS+98, 2+4*next_car_road_lane,map_waypoints_s,map_waypoints_x,map_waypoints_y);
